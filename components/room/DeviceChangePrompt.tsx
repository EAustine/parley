...
export function DeviceChangePrompt({
  ...
  return (
    <div
      ...
      role="status"
      aria-live="polite"
      className="absolute inset-x-0 top-0 z-[var(--layer-notices)] mx-auto flex w-fit max-w-[calc(100vw-1rem)] flex-wrap items-center justify-center gap-3 rounded-b-xl px-4 py-3"
